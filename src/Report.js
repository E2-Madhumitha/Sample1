                        ...
                        <p> (please indicate any important details about the installation)</p>
									...
									displayPage == 2 ?
										<div className="flexWrap" style={{ overflow: "auto" }}>
											...
											<Input  type="text"  label="-if so please describe"  customClassName={"width-50"} style={{ "display": "block" }}  />
														</div>
													</div>
                                                    <div className="questionsFormat">
										<div className="spanDiv">
										...
										<div className="answerDisplay" style={{ "display": "block" }}>
										<Input  type="text" rows='3' label=""  customClassName="input-container-5" style={{ "display": "block" }}  />
										</div>
                                        </div>
                                        <div className="questionsFormat">
										<div className="spanDiv">
											<div className="questionDisplay">
                                            Handle rotations to fill 20 L container 
                                    ...
                                    <div className="questionsFormat">
										<div className="spanDiv">
                                            ...
                                            <p>(visual assessment – take photo)</p>
											</div>
										</div>
										<div className="answerDisplay radio" >
											<RadioGroup
										...
										<div className="spanDiv">
											<div className="questionDisplay">
                                            If pump has not been maintenanced for more than 1 year, ask community member:
                                            <p>“How has the LifePump benefited your community?”</p>
											</div>
										</div>
										<div className="answerDisplay" >
										
                                        <Input  type="text" rows='5' label=""  customClassName={"input-container-5" } maxLength="400" style={{ "display": "block" }}  />
...
If pump has been maintenanced within the last 1 year, ask community member:
<p>“Do you understand what the problem was with your LifePump?” </p>
											</div>
										</div>
										<div className="answerDisplay" >
                                    ...
                                    <div className="questionsFormat">
										<div className="spanDiv">
											<div className="questionDisplay">
                                           Please record name and age of person being interviewed and take photo. 
                                        ...
                                        <Input  type="text"  label=""  customClassName={"input-container-5" } maxLength="400" style={{ "display": "block" }}  />
						...
						<div className="answerDisplay radio" >
							...
							>
                                  <FormControlLabel
													value={4}
													control={<Radio color="primary"  />}
													label={"Replaced and/or broken components"}
												/>
								<FormControlLabel
													value={3}
													control={<Radio color="primary"  />}
								...
								<FormControlLabel
													value={1}
													control={<Radio color="primary"  />}
													label={"5-10 additional photos from installation and when LP is operating "}
												/>
												<FormControlLabel
													value={0}
													control={<Radio color="primary"/>}
													label={"1-3 short videos of LP operating"}
												/>
							</RadioGroup>
						</div>
					</div>
